...
#
gap> START_TEST("groupoids07.tst");

# doc/ggraph.xml:42-52
gap> V1 := [7,8];;
gap> fg1 := FreeGroup("y");;
gap> y := fg1.1;;
...
#
gap> STOP_TEST("groupoids07.tst", 1);

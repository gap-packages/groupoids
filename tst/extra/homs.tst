...
>           [ (), (1,2,3,4), (1,3,4,2), (1,4,2,3), (3,4) ] );;
gap> Display(H);
single piece groupoid with rays having:
      objects: [ -9, -8, -7, -6, -5 ]
   root group: a4 = <[ (1,2,3), (2,3,4) ]>
         rays: [ (), (1,2,3,4), (1,3,4,2), (1,4,2,3), (3,4) ]
gap> SetName( H, "H" );
...
[ [ [(1,2,3) : -9 -> -9], [(2,3,4) : -9 -> -9], [(1,2,3,4) : -9 -> -8], 
      [(1,3,4,2) : -9 -> -7], [(1,4,2,3) : -9 -> -6], [(3,4) : -9 -> -5] ], 
...
[ [ [(1,2,3) : -4 -> -4], [(2,3,4) : -4 -> -4], [(1,4) : -4 -> -3], 
      [(2,4) : -4 -> -2], [(3,4) : -4 -> -1] ], 
  [ [(1,2,4) : -19 -> -19], [(1,2,3) : -19 -> -19], [(1,3,4,2) : -19 -> -16], 
      [(2,4) : -19 -> -17], [(1,4) : -19 -> -18] ] ]
gap> isoSJ := IsomorphismNewObjects( SJ, [-14,-13,-12,-11,-10]);;
gap> SK := Image( isoSJ );
single piece groupoid: < s4, [ -14, -13, -12, -11, -10 ] >
gap> jk0 := RestrictedMappingGroupoids( isoSJ, J );;
gap> jk := ReduceRangeToImage( jk0 );
...
[ [ [(1,2,3) : -4 -> -4], [(2,3,4) : -4 -> -4], [(1,4) : -4 -> -3], 
      [(2,4) : -4 -> -2], [(3,4) : -4 -> -1] ], 
  [ [(1,2,4) : -14 -> -14], [(1,2,3) : -14 -> -14], [(1,3,4,2) : -14 -> -11], 
      [(2,4) : -14 -> -12], [(1,4) : -14 -> -13] ] ]
...
gap> SetName( DD, "DD" );
gap> cd0 := RestrictedMappingGroupoids( isoDC, C );;
gap> cd := ReduceRangeToImage( cd0 );
groupoid homomorphism :
...
[ (28,37,46)(29,38,47)(30,39,48)(31,40,49)(32,41,50)(33,42,51)(34,43,52)
  ...
  ( 2, 7,10,55, 3, 4,19,28)( 5,25,37,56, 9,13,73,30)( 6,22,46,29, 8,16,64,57)
    (11,61,12,58,21,31,20,34)(14,79,39,59,27,40,74,36)(15,76,48,32,26,43,65,63
     ...
     54)(44,71,72,69,78,51,50,53) ] ), [ -35, -34, -33, -32, -31 ], 
